...
struct Factory: public scriptnode::dll::StaticLibraryHostFactory
{
	Factory()
	{
		...
		registerDataNode<project::buff_networkdata>();
		registerDataNode<project::g1stack_networkdata>();
		registerDataNode<project::Gr_networkdata>();
		...
		registerDataNode<project::k_networkdata>();
		registerDataNode<project::min_networkdata>();
		registerDataNode<project::modcont_networkdata>();
		registerDataNode<project::_networkdata>();
		registerDataNode<project::ng_networkdata>();
