...
using chain350_t = container::chain<parameter::empty, 
                                    ...
                                    math::add<NV>>;
using global_cable330_t_index = global_cable5_t_index;
...
using chain351_t = container::chain<parameter::empty, 
                                    ...
                                    math::add<NV>>;
using global_cable331_t_index = global_cable4_t_index;
...
using chain352_t = container::chain<parameter::empty, 
                                    ...
                                    math::add<NV>>;
using global_cable332_t_index = global_cable3_t_index;
...
using chain353_t = container::chain<parameter::empty, 
                                    ...
                                    math::add<NV>>;
using global_cable333_t_index = global_cable45_t_index;
...
template <int NV> struct instance: public sn_impl::sn_t_<NV>
{
	...
	struct metadata
	{
		...
		SNEX_METADATA_ENCODED_PARAMETERS(1386)
		{
            ...
            0x8000, 0x0040, 0x4000, 0x0040, 0x8000, 0x003F, 0x8000, 0x5C3F, 
            ...
            0x23D7, 0x003C, 0x8000, 0x003F, 0x0000, 0x5C00, 0x0600, 0x0000, 
            0x5000, 0x736F, 0x7469, 0x6F69, 0x4D6E, 0x646F, 0x0000, 0x0000, 
            0xBF80, 0x0000, 0x3F80, 0x47AE, 0x3DE1, 0x0000, 0x3F80, 0x0000, 
            0x0000, 0x005C, 0x0007, 0x0000, 0x6F50, 0x6973, 0x6974, 0x6E6F, 
            0x7253, 0x0063, 0x0000, 0x8000, 0x003F, 0x8000, 0x0041, 0xC000, 
            ...
            0x5C29, 0xBE8F, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x000A, 
            0x0000, 0x6F50, 0x3273, 0x7253, 0x0063, 0x0000, 0x8000, 0x003F, 
            0x8000, 0x0041, 0xA000, 0x0040, 0x8000, 0x003F, 0x8000, 0x5C3F, 
            ...
            0xBF80, 0x0000, 0x3F80, 0xEB85, 0x3F11, 0x0000, 0x3F80, 0x0000, 
            0x0000, 0x005C, 0x000D, 0x0000, 0x6F50, 0x3373, 0x7253, 0x0063, 
            0x0000, 0x8000, 0x003F, 0x8000, 0x0041, 0xA000, 0x0040, 0x8000, 
            ...
            0x646F, 0x0000, 0x0000, 0xBF80, 0x0000, 0x3F80, 0x0000, 0xBF00, 
            ...
            0x3335, 0x3FB3, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x0012, 
            ...
            0x0000, 0x8000, 0x313F, 0xD408, 0x003E, 0x8000, 0x003F, 0x0000, 
            ...
            0x0000, 0xA000, 0x0040, 0x7A00, 0x0044, 0x5840, 0x0044, 0x8000, 
            ...
            0x0000, 0x0000, 0x9000, 0x0041, 0x0000, 0x0041, 0x8000, 0x003F, 
            0x8000, 0x5C3F, 0x2300, 0x0000, 0x4700, 0x6172, 0x6E69, 0x6944, 
            0x0076, 0x0000, 0x8000, 0x003F, 0x0000, 0x0042, 0x9000, 0x0041, 
            ...
            0x4D74, 0x646F, 0x0000, 0x0000, 0xBF80, 0x0000, 0x3F80, 0xD70A, 
            0x3EA3, 0x0000, 0x3F80, 0x0000, 0x0000, 0x005C, 0x0028, 0x0000, 
            ...
            0x6863, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x8F5C, 0x3E42, 
            ...
            0x704C, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0xE000, 0x3F7E, 
            ...
            0x0000, 0x0000, 0x8000, 0x5C3F, 0x428F, 0x003E, 0x8000, 0x003F, 
            0x0000, 0x5C00, 0x3500, 0x0000, 0x5000, 0x736F, 0x4374, 0x7475, 
            0x6F4D, 0x0064, 0x0000, 0x8000, 0x00BF, 0x8000, 0x7B3F, 0x2E14, 
            0x003E, 0x8000, 0x003F, 0x0000, 0x5C00, 0x3600, 0x0000, 0x5000, 
            ...
            0x003F, 0x0000, 0x0000, 0x8000, 0x003F, 0x0000, 0x5C00, 0x3C00, 
            0x0000, 0x6700, 0x6961, 0x536E, 0x6372, 0x0000, 0x0000, 0x0000, 
            0x0000, 0x3F80, 0x0000, 0x3F80, 0x0000, 0x3F80, 0x0000, 0x0000, 
            0x005C, 0x003D, 0x0000, 0x6F56, 0x006C, 0x0000, 0x0000, 0x0000, 
            0x8000, 0x8F3F, 0xF5C2, 0x003E, 0x8000, 0x003F, 0x0000, 0x5C00, 
            ...
            0xC000, 0x0040, 0x8000, 0x003F, 0x8000, 0x5C3F, 0x4500, 0x0000, 
            ...
            0x7265, 0x0000, 0x0000, 0x0000, 0x0000, 0x3F80, 0x7AE1, 0x3F54, 
	...
	instance()
	{
		...
		gain3.setParameterT(2, -12.); // core::gain::ResetValue
		...
		this->setParameterT(46, 0.19);
		this->setParameterT(47, 0.);
		this->setParameterT(48, 3.);
		this->setParameterT(49, 0.995605);
		this->setParameterT(50, 0.);
		this->setParameterT(51, 13.);
		this->setParameterT(52, 0.19);
		this->setParameterT(53, 0.17);
