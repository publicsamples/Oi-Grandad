...
struct _granular final : public ::faust::dsp {
	...
	void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = std::max<float>(0.0f, std::min<float>(1.5f, float(fHslider2)));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp22 = fTemp10 * ftbl1[iTemp8] + fTemp3 * ftbl1[iTemp4] + ftbl1[iTemp13] * fTemp15 + ftbl1[iTemp18] * fTemp20;
			fVec5[0] = fTemp22;
