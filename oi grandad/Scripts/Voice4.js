...
const var PolyMetaB4 = Content.getComponent("PolyMetaB4");
...
inline function onHiddenFiles4Control(component, value)
{
    ...
    slot4.loadFile(AudioList[value - 1]);
...
inline function onRANDOMISE4Control(component, value)
{
    ...
    randomiseIfUnlockedD(12, PolyMeta4);
    randomiseIfUnlockedD(13, PolyMetaB3);
