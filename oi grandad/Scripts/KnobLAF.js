...
Content.getComponent("WindowTempo1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("Window1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("DelayPitch1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("DelayTime2").setLocalLookAndFeel(KnobLaf);
Content.getComponent("Xf1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("Dense1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("cutoff1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("Xf1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("Dense1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("cutoff1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("Xf1").setLocalLookAndFeel(KnobLaf);
Content.getComponent("graintempo1").setLocalLookAndFeel(KnobLaf);
