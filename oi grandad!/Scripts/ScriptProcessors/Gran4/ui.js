...
Pbox[0] = Content.getComponent("FloatingTile1");
Pbox[1] = Content.getComponent("FloatingTile2");
Pbox[2] = Content.getComponent("FloatingTile3");
...
PitchMod1[0] = Content.getComponent("pitch1lfo1");
PitchMod1[1] = Content.getComponent("pitch1lfo2");
PitchMod1[2] = Content.getComponent("pitch1lfo3");
PitchMod1[3] = Content.getComponent("pitch1lfo4");
PitchMod1[4] = Content.getComponent("pitch1lfo5");
PitchMod1[5] = Content.getComponent("pitch1lfo6");
PitchMod1[6] = Content.getComponent("pitch1lfo7");
PitchMod1[7] = Content.getComponent("pitch1lfo8");
PitchMod1[8] = Content.getComponent("pitch1lfo9");
PitchMod1[9] = Content.getComponent("pitch1lfo10");

const var cmbpitch1 = Content.getComponent("pitch1modsel");

inline function onpitch1modselControl(component, value)
{
    for (i = 0; i < PitchMod1.length; i++)
        PitchMod1[i].showControl(value - 1 == i);
};

Content.getComponent("pitch1modsel").setControlCallback(onpitch1modselControl);
...
PitchMod2[0] = Content.getComponent("pitch1lfo11");
PitchMod2[1] = Content.getComponent("pitch1lfo12");
PitchMod2[2] = Content.getComponent("pitch1lfo13");
PitchMod2[3] = Content.getComponent("pitch1lfo14");
PitchMod2[4] = Content.getComponent("pitch1lfo15");
PitchMod2[5] = Content.getComponent("pitch1lfo16");
PitchMod2[6] = Content.getComponent("pitch1lfo17");
PitchMod2[7] = Content.getComponent("pitch1lfo18");
PitchMod2[8] = Content.getComponent("pitch1lfo19");
PitchMod2[9] = Content.getComponent("pitch1lfo20");

const var cmbpitch2 = Content.getComponent("pitch2modsel");

inline function onpitch2modselControl(component, value)
{
    for (i = 0; i < PitchMod2.length; i++)
        PitchMod2[i].showControl(value - 1 == i);
};

Content.getComponent("pitch2modsel").setControlCallback(onpitch2modselControl);
...
PitchMod3[0] = Content.getComponent("pitch1lfo21");
PitchMod3[1] = Content.getComponent("pitch1lfo22");
PitchMod3[2] = Content.getComponent("pitch1lfo23");
PitchMod3[3] = Content.getComponent("pitch1lfo24");
PitchMod3[4] = Content.getComponent("pitch1lfo25");
PitchMod3[5] = Content.getComponent("pitch1lfo26");
PitchMod3[6] = Content.getComponent("pitch1lfo27");
PitchMod3[7] = Content.getComponent("pitch1lfo28");
PitchMod3[8] = Content.getComponent("pitch1lfo29");
PitchMod3[9] = Content.getComponent("pitch1lfo30");

const var cmbpitch3 = Content.getComponent("pitch3modsel");

inline function onpitch3modselControl(component, value)
{
    for (i = 0; i < PitchMod3.length; i++)
        PitchMod3[i].showControl(value - 1 == i);
};

Content.getComponent("pitch3modsel").setControlCallback(onpitch3modselControl);
...
PitchMod4[0] = Content.getComponent("pitch1lfo31");
PitchMod4[1] = Content.getComponent("pitch1lfo32");
PitchMod4[2] = Content.getComponent("pitch1lfo33");
PitchMod4[3] = Content.getComponent("pitch1lfo34");
PitchMod4[4] = Content.getComponent("pitch1lfo35");
PitchMod4[5] = Content.getComponent("pitch1lfo36");
PitchMod4[6] = Content.getComponent("pitch1lfo37");
PitchMod4[7] = Content.getComponent("pitch1lfo38");
PitchMod4[8] = Content.getComponent("pitch1lfo39");
PitchMod4[9] = Content.getComponent("pitch1lfo40");

const var cmbpitch4 = Content.getComponent("pitch4modsel");

inline function onpitch4modselControl(component, value)
{
    for (i = 0; i < PitchMod4.length; i++)
        PitchMod4[i].showControl(value - 1 == i);
};

Content.getComponent("pitch4modsel").setControlCallback(onpitch4modselControl);
